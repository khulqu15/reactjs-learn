...
export default function Register() {
  const [email, setEmail] = useState("eve.holt@reqres.in");   // contoh yg didukung reqres
  const [password, setPassword] = useState("pistol");         // contoh reqres
  ...
  return (
    <div className="max-w-sm mx-auto space-y-3">
      ...
      <p className="text-xs text-gray-500">
        Contoh kredensial reqres: <code>eve.holt@reqres.in</code> / <code>pistol</code>
      </p>
