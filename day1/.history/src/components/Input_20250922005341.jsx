// Input.jsx — versi aman (tidak meneruskan `children` ke <input>)
export default function Input({
  ...
  error,
  className = '',
  children,       // <- diterima tapi TIDAK dilempar ke <input>
  ...props        // <- sisa props yang aman untuk <input>
}) {
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <input
        ...
        {...props}     // <- tidak ada children di sini
      />

      {/* opsional: render children DI LUAR input */}
      {children}
